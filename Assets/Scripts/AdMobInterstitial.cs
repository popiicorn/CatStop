...
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-6736870106967218/9311590022";//ここにAndroidのインタースティシャル広告IDを入力

#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-6736870106967218/2220317463";//ここにiOSのインタースティシャル広告IDを入力
